...
$mysqli->close();
// Accès à la valeur de "artemis nuits"
$nom_carte = $carteArray[1]['nom_carte'];
$attaque_carte = $carteArray[1]['attaque_carte'];
$vie_carte = $carteArray[1]['vie_carte'];

echo "Nom de la carte: $nom_carte, Attaque: $attaque_carte, Vie: $vie_carte";
